...
```
conda env create -f ./pyenv_TUD_BI.yml 
```
This may take a while because we use Pytorch, which usually takes a while to install (should not take longer than 5 minutes).
